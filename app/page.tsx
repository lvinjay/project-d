    ...
    <main>
      ...
      <section className="hero heroV32">
        ...
        <div className="heroContent">
          ...
          <form
            className="decisionSearch decisionSearchV32"
        ...
        <aside className="decisionPreview" aria-label="추천 결과 예시">
          ...
          <div className="previewNote">
            구매 전 확인: 배터리 지속시간은 사용 환경에 따라 달라질 수
            있습니다.
          </div>
        </aside>
      </section>
      ...
      <section className="container proofSection" id="value">
        <div className="sectionHeadingRow">
          ...
          <p className="sectionLead compactLead">
            광고 순위나 인기순이 아니라, 개인 조건과 실제 사용 경험을 함께
            반영해 선택 이유까지 설명합니다.
          </p>
        </div>
