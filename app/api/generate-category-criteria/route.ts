...
18. 예를 들어 물걸레 구동 방식과 물걸레 특화 여부가 모두 결국 실제 물걸레 청소 만족도를 평가하기 위한 것이라면 중복 기준으로 나누지 말고 '물걸레 청소 성능'처럼 통합하는 것을 우선하세요.
19. 장애물 센서의 명칭이나 AI/RGB 표기 자체보다 실제 장애물 회피, 맵핑, 주행 안정성처럼 사용자가 체감하는 결과를 기준으로 삼으세요.
20. 세척·건조·먼지비움 등 여러 자동 기능은 필요하면 '자동관리 편의성'처럼 하나의 소비자 관점 기준으로 통합하세요.

21. 최종 5개 기준은 서로 다른 구매 고민을 대표해야 합니다.
22. 가능하면 제품의 핵심 청소 성능, 부가기능 성능, 주행/인식 성능, 자동관리·유지관리, 사용편의·안정성처럼 서로 다른 축을 균형 있게 검토하세요.
23. 단, 위 예시는 강제 고정 기준이 아닙니다. 실제 제공된 제품 데이터에서 근거가 있어야 선정하세요.
