...
function ResultLoading() {
  return <main><Header /><section className="container emptyState"><h1>AI 비교 결과를 불러오는 중입니다.</h1><p className="sectionLead">잠시만 기다려 주세요.</p></section></main>;
}

export default function ResultPage() {
  return <Suspense fallback={<ResultLoading />}><ResultContent /></Suspense>;
}
