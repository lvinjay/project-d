    ...
    <main>
      ...
      <section className="container">
        <div className="resultHero">
          ...
          >
            {result[0]?.name}이 가장 잘 맞습니다.
          </h1>

          <p>
            {result.length}개 제품의 스펙, 예산 적합도, 리뷰 만족도를 함께
            반영한 결과입니다.
          </p>
        </div>
          ...
          >
            <div className="rankCard">
              ...
              <div>
                ...
                <p style={{ margin: 0 }}>
                  {item.price.toLocaleString()}원 · {item.weightKg}kg · 리뷰{" "}
                  {item.reviewCount.toLocaleString()}건
                </p>
              </div>
